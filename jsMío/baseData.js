...
// Funcion que retorna un array de Product
function getProducts() {
	let productsAsObjects = JSON.parse(DATA_FROM_DATABASE);

	//  Creo el arreglo con el metodo for..of..

	// let products = [];
	// for(element of productsAsObjects){
	//     let product = new Product(element.id, element.name, element.price, element.stock, element.img)
	//     products.push(product)
	// }

	//  Creo el arreglo usando map + arrow function
...
// String con formato JSON para mi base de datos 
